package com.example.test_ai_project.auth.presentation.testing
 ...
 * state immediately after calling a method, with no `advanceUntilIdle()`. Pass a
 * `StandardTestDispatcher` when a test needs to observe the in-flight state instead.
 *
