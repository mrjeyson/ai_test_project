...
data class CalendarDate(
    ...
    companion object {
         ...
         *
         * Lives here rather than in either layer that needs it. The data layer buckets a forecast
         * by the location's date and the UI asks whether a row is today; those have to agree, and
         * two copies of this arithmetic are how they would stop agreeing.
         */
