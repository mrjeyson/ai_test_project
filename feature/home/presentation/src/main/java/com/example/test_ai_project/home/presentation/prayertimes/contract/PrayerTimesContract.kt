package com.example.test_ai_project.home.presentation.prayertimes.contract
...
sealed interface PrayerTimesEvent : UiEvent {
    /** The location permission dialogs have been answered, or found already answered. */
    data object PermissionsResolved : PrayerTimesEvent

    data object RetryRequested : PrayerTimesEvent

    /** Re-detect the device position and refetch against it. */
    data object LocationChangeRequested : PrayerTimesEvent

    data object MessageDismissed : PrayerTimesEvent
}
