...
private fun MessageBanner(
    ...
    Row(
        ...
        TextButton(onClick = onDismiss) {
            Text(text = stringResource(id = R.string.movies_dismiss))
        }
    }
}
...
private fun EmptyState(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.movies_empty_title),
            style = MaterialTheme.typography.bodyLarge,
            color = MaterialTheme.colorScheme.onBackground,
            modifier = Modifier.padding(top = 12.dp),
        )
        Text(
            text = stringResource(id = R.string.movies_empty_body),
    ...
    AppTheme {
        MoviesScreen(
            uiState = MoviesUiState(
                ...
                messageRes = R.string.movies_error_unreachable,
            ),
            onPageSelected = {},
            onRetry = {},
            onDismissMessage = {},
