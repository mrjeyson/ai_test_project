        ...
        if (uiState.messageRes != null) {
            MessageBanner(
                ...
                actionRes = if (uiState.isPermissionRequestable) {
                    R.string.prayer_allow
                } else {
                    R.string.prayer_retry
                },
...
private fun PrayerTimesContent(
    ...
    Column(
        ...
        Column(modifier = Modifier.padding(horizontal = 16.dp)) {
            ...
            Text(
                text = stringResource(id = R.string.prayer_daily_schedule),
        ...
        Column {
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = stringResource(id = R.string.prayer_cached_badge),
                ...
                if (lastUpdatedLabel != null) {
                    Text(
                        text = stringResource(id = R.string.prayer_last_update, lastUpdatedLabel),
    ...
    Surface(
        ...
        Column(
            ...
            if (next == null) {
                ...
                Text(
                    text = stringResource(id = R.string.prayer_all_complete),
                ...
                Text(
                    text = stringResource(
                        id = if (next.isTomorrow) {
                            R.string.prayer_starts_at_tomorrow
                        } else {
                            R.string.prayer_starts_at
                        },
...
private fun StatusChip(status: PrayerStatus, modifier: Modifier = Modifier) {
    val labelRes = when (status) {
        PrayerStatus.Completed -> R.string.prayer_status_completed
        PrayerStatus.Next -> R.string.prayer_status_upcoming
    ...
    Surface(
        ...
        Row(
            ...
            TextButton(onClick = onChangeLocation, enabled = !isLocating) {
                Text(
                    text = stringResource(
                        id = if (isLocating) R.string.prayer_locating else R.string.prayer_change_location,
                    ),
...
private fun MessageBanner(
    ...
    Row(
        ...
        TextButton(onClick = onDismiss) {
            Text(text = stringResource(id = R.string.prayer_dismiss))
        }
    }
}
...
private fun EmptyState(onRetry: () -> Unit, modifier: Modifier = Modifier) {
    Column(
        ...
        Button(onClick = onRetry, modifier = Modifier.padding(top = 20.dp)) {
            Text(text = stringResource(id = R.string.prayer_retry))
        }
    }
}
...
private val Prayer.captionRes: Int
    get() = when (this) {
        Prayer.Fajr -> R.string.prayer_fajr_caption
        Prayer.Dhuhr -> R.string.prayer_dhuhr_caption
        Prayer.Asr -> R.string.prayer_asr_caption
        Prayer.Maghrib -> R.string.prayer_maghrib_caption
        Prayer.Isha -> R.string.prayer_isha_caption
    }
    ...
    AppTheme {
        PrayerTimesScreen(
            uiState = previewUiState().copy(
                messageRes = R.string.prayer_error_unreachable,
                isLoading = true,
            ),
            remainingMillis = PreviewAsr - PreviewNow,
            onRetry = {},
...
private fun previewUiState() = PrayerTimesUiState(
    entries = listOf(
