...
class PrayerAlarmReceiver : BroadcastReceiver() {
    ...
    @Inject
    lateinit var schedulePrayerAlerts: SchedulePrayerAlertsUseCase
    ...
    companion object {
        ...
        const val ACTION_PRAYER_ALERT =
            "com.example.test_ai_project.core.data.action.PRAYER_ALERT"

        const val EXTRA_PRAYER = "com.example.test_ai_project.core.data.extra.PRAYER"
